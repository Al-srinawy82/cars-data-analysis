                ...
                <form>
                    ...
                    <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getMonthProperty" wire:model="yearId" class="form-control" id="users-list-status">
                        ...
                        <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getDayFromProperty" wire:model="monthId" class="form-control" id="users-list-status">
                                        <option value="Active"></option>
                                    @if($months)
                        ...
                        <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getDayToProperty" wire:model="dayFromId" class="form-control" id="users-list-status">
                        ...
                        <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getTimeFromProperty" wire:model="dayToId" class="form-control" id="users-list-status">
                        ...
                        <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getTimeToProperty" wire:model="timeFromVal" class="form-control" id="users-list-verified">
                                    @if($timesFrom)
                        ...
                        <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getGateProperty"  wire:model="timeToVal" class="form-control" id="users-list-department">
                        ...
                        <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getDirectionProperty"  wire:model="gateId" class="form-control" id="users-list-department">
                        ...
                        <div class="col-sm-6 col-lg-2  col-md-3">
                            ...
                            <fieldset class="form-group">
                                <select wire:change="getResult"  wire:model="directionId" class="form-control" id="users-list-department">
